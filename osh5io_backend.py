...
osh5io_backend.py
=========
Disk IO backend. Currently support ZDF and HDF5 format.
"""
...
try:
    ...
    def open_zdf_and_extract_data(filename, path=None):
        """
        HDF reader for Osiris/Visxd compatible ZDF files.
        Returns: Data structure needed to initialize H5Data object.
        """
...
def open_h5_and_extract_data(filename, path=None, axis_name="AXIS/AXIS"):
    """
        ...
        for it, data_group in data_file[dataPath].items():
            ...
            for fld, data in data_file[meshesPath].items():
                ...
                if isinstance(data, h5py.Dataset):
                    ...
                    fldl[it+'/'+data_attrs['NAME']] = ( (data, timestamp, data_attrs, grid_attrs, axes, rt_attrs))
                # vector data
                    ...
                    for k, v in data.items():
                        ...
                        fldl[it+'/'+data_attrs['NAME']] = ( (v, timestamp, data_attrs, grid_attrs, axes, rt_attrs))
